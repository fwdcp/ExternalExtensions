...
public:
	...
	virtual const QAngle &LocalEyeAngles() = 0;		// Direction of eyes
	...
	virtual	bool				Weapon_Switch( C_BaseCombatWeapon *pWeapon, int viewmodelindex = 0 ) = 0;		// Switch to given weapon if has ammo (false if failed)
